...
def save(location):  # working
    ...
    # giving the location object an id based on the id given by the database, as the location class has an id of its own (separate from database), but this line makes them the same
